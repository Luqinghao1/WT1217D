...
#include "fittingpage.h" // [修改] 引入 FittingPage
...
void MainWindow::onProjectCreated()
{
    ...
    if (m_FittingPage) {
        ...
        m_FittingPage->loadAllFittingStates(); // [修改]
    }
